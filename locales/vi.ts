...
export default {
  ...
  "settings": {
    "title": "Cài đặt",
    "rolesPermissionsTab": "Vai trò & Quyền",
    "aiProvider": {
  ...
  "permissions": {
    ...
    "view_assigned_to": "Xem Người phụ trách",
    "edit_assigned_to": "Sửa Người phụ trách",
    ...
    "view_thumbnail": "Xem Ảnh bìa",
    "edit_thumbnail": "Tải lên/Thay đổi Ảnh bìa",
    "view_thumbnail_prompt": "Xem Prompt ảnh bìa",
    "edit_thumbnail_prompt": "Sửa Prompt ảnh bìa",
    "view_voiceover_script": "Xem Kịch bản lồng tiếng",
    "edit_voiceover_script": "Sửa Kịch bản lồng tiếng",
    ...
    "view_timecode_map": "Xem Bản đồ timecode",
    "edit_timecode_map": "Sửa Bản đồ timecode",
    "view_seo_metadata": "Xem SEO Metadata",
    "edit_seo_metadata": "Sửa SEO Metadata",
    "view_metadata": "Xem Metadata",
    "edit_metadata": "Sửa Metadata",
    "action_generate_ai_content": "Tạo bằng AI (Văn bản)",
    "action_generate_thumbnail_image": "Tạo Ảnh bìa",
    "action_delete_project": "Xóa Dự án",
    "action_copy_project": "Sao chép Dự án",
    "action_rerun_automation": "Chạy lại Tự động hóa",
    "action_move_project": "Chuyển Dự án sang kênh khác",
    "manage_channel_settings": "Sửa Cài đặt Kênh (Tên, DNA)",
    "manage_channel_members": "Quản lý Thành viên Kênh (Mời, Xóa)",
    "manage_channel_roles": "Quản lý Vai trò & Quyền Kênh",
